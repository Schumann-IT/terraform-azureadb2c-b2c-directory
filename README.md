...
| Name | Description |
|------|-------------|
| <a name="output_custom_app_registrations"></a> [custom\_app\_registrations](#output\_custom\_app\_registrations) | Custom app registrations |
...
| <a name="output_storage_account"></a> [storage\_account](#output\_storage\_account) | The template storage account |
